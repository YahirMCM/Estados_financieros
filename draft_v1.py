...
while True:
    ...
    if main_menu == 1:
        ...
        prueba_acida_1 = (balance_general.at[year1, 'totalActivosCirculantes'] - cuentas.at[year1, 'inv']) / balance_general.at[year1, 'totalPasivosCirculantes']
        prueba_acida_2 = (balance_general.at[year2, 'totalActivosCirculantes'] - cuentas.at[year2, 'inv']) / balance_general.at[year2, 'totalPasivosCirculantes']
        ...
        Cap_de_trabajo1 = balance_general.at[year1, 'totalActivosCirculantes'] - balance_general.at[year1, 'totalPasivosCirculantes']
        ...
        t_cce.add_column(f"{year2}", justify="center", style="yellow", no_wrap=False)
        ...
        margenUtility_y1 = (estado_resultados.at[year1, 'utilidadNetaEjercicio'] / cuentas.at[year1, 'ventas']) * 100
        margenUtility_y2 = (estado_resultados.at[year2, 'utilidadNetaEjercicio'] / cuentas.at[year2, 'ventas']) * 100
        
        margenUtilityBruta_y1 = (estado_resultados.at[year1, 'utilidadBruta'] / cuentas.at[year1, 'ventas']) * 100
        margenUtilityBruta_y2 = (estado_resultados.at[year2, 'utilidadBruta'] / cuentas.at[year2, 'ventas']) * 100
        
        margenUtilityOp_y1 = (estado_resultados.at[year1, 'utilidadOperativa'] / cuentas.at[year1, 'ventas']) * 100
        margenUtilityOp_y2 = (estado_resultados.at[year2, 'utilidadOperativa'] / cuentas.at[year2, 'ventas']) * 100
        
        RAT_y1 = (estado_resultados.at[year1, 'utilidadNetaEjercicio'] / balance_general.at[year1, 'totalActivos']) * 100
        RAT_y2 = (estado_resultados.at[year2, 'utilidadNetaEjercicio'] / balance_general.at[year2, 'totalActivos']) * 100
        
        ROE_y1 = (estado_resultados.at[year1, 'utilidadNetaEjercicio'] / balance_general.at[year1, 'totalCapital']) * 100
        ROE_y2 = (estado_resultados.at[year2, 'utilidadNetaEjercicio'] / balance_general.at[year2, 'totalCapital']) * 100
        
        RCC_y1 = (estado_resultados.at[year1, 'utilidadNetaEjercicio'] / cuentas.at[year1, 'capitalSocial']) * 100
        RCC_y2 = (estado_resultados.at[year2, 'utilidadNetaEjercicio'] / cuentas.at[year2, 'capitalSocial']) * 100
        ...
        v_accion = float(input("Dame el valor de una accion:\n"))
        cant_acciones = int(input("Dame la cantidad de acciones en circulacion:\n"))

        utilidad_accion1 = estado_resultados.at[year1,'utilidadNetaEjercicio'] / cant_acciones
        utilidad_accion2 = estado_resultados.at[year2,'utilidadNetaEjercicio'] / cant_acciones
        ...
        valor_libros_accion1 = balance_general.at[year1, 'totalCapitalContable'] / cant_acciones
        valor_libros_accion2 = balance_general.at[year2, 'totalCapitalContable'] / cant_acciones

        t_mkvalue = Table(title= 'VALOR DE MERCADO', show_lines=True)
        t_mkvalue.add_column("CONCEPTO", justify="center", style="cyan", no_wrap=False)
        t_mkvalue.add_column(f"{year1}", justify="center", style="yellow", no_wrap=False)
        t_mkvalue.add_column(f"{year2}", justify="center", style="yellow", no_wrap=False)

        t_mkvalue.add_row("Valor de accion", f"${v_accion:.2f}", f"${v_accion:.2f}")
        t_mkvalue.add_row("Cantidad de acciones en mercado", f"{cant_acciones:.2f}", f"{cant_acciones:.2f}")
        t_mkvalue.add_row("Utilidad de accion", f"${utilidad_accion1:.2f}", f"${utilidad_accion2:.2f}")
        t_mkvalue.add_row("Valor nominal de accion", f"${valor_nominal_accion1:.2f}", f"${valor_nominal_accion2:.2f}")
        t_mkvalue.add_row("Valor en libros de accion", f"${valor_libros_accion1:.2f}", f"${valor_libros_accion2:.2f}")

        console.print(t_mkvalue)
